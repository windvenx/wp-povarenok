    ...
    <div class="container">
        ...
        <div class="footer-next-block">
            <form class="subscribe-form" action="#" method="post" novalidate>
                <input class="subscribe-input" type="email" name="email" placeholder="Подписаться на рассылку"
                    aria-label="Email">
            ...
            <div class="footer-contacts">
                <div class="contact-item">
                    <svg class="icon" width="14" height="14" viewBox="0 0 24 24" aria-hidden>
                        <path fill="currentColor"
                            d="M6.6 10.8a15.05 15.05 0 006.6 6.6l2.2-2.2a1 1 0 01.9-.3c1 .2 2 .3 2.9.3a1 1 0 011 1v3.7a1 1 0 01-1 1A19 19 0 013 5a1 1 0 011-1h3.7a1 1 0 011 1c0 1 .1 1.9.3 2.9.1.4-.1.8-.3.9L6.6 10.8z" />
                    </svg>
                ...
                <div class="contact-item">
                    <svg class="icon" width="14" height="14" viewBox="0 0 24 24" aria-hidden>
                        <path fill="currentColor"
                            d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-1.2 4.1L12 13 5.2 8.1 6 7.4 12 11l6-3.6.8.1z" />
                    </svg>
                    <div class="mail-list">
                ...
                <div class="contact-item addr">
                    <svg class="icon" width="14" height="14" viewBox="0 0 24 24" aria-hidden>
                        <path fill="currentColor"
                            d="M12 2C8.1 2 5 5.1 5 9c0 5.3 7 13 7 13s7-7.7 7-13c0-3.9-3.1-7-7-7zM12 11.5c-1.4 0-2.5-1.1-2.5-2.5S10.6 6.5 12 6.5s2.5 1.1 2.5 2.5S13.4 11.5 12 11.5z" />
                    </svg>
                    <div class="addr-text">
    ...
    <div class="footer-legal">
        <div class="container footer-legal__inner">
            <div class="footer-legal__logo" aria-hidden="true">
                <svg version="1.1" id="logo_pt" xmlns:cc="http://creativecommons.org/ns#"
                    xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
                    xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="222" height="69"
            ...
            C640.5-208.3,641.2-212.3,641.2-216.9"></path>
                            <path id="path34" class="st3"
                                d="M525.2-120.1l-9.2-44h-41.6l-22.5-110.1h-74.7L399.7-164h-41.3l9.2,44H525.2">
                            </path>
            ...
            c-8.9,0-14.9,7.3-13.2,15.9l12.2,69.4C605.2,127.1,613.8,134.1,622.3,134.1"></path>
                            <path id="path38" class="st0"
                                d="M674.9,102.3h-23.5l-8.9-45.3h-11.6l10.9,55.5h35.3L674.9,102.3"></path>
            ...
            s-3.3-4-4.3-6.6h18.2c0.7,3,0.7,5.3-0.3,6.9C1168.7,90.4,1166.7,91.4,1163.7,91.4"></path>
                            <path id="path60" class="st0"
                                d="M1218.2,89.1h-15.5l-6.3-31.7h-11.2l7.9,41.6h38l-7.9-41.6h-10.9L1218.2,89.1">
                            </path>
                            <path id="path62" class="st0"
                                d="M1273.7,89.1h-12.9l-6.3-31.7H1243l6.3,31.7h-12.9l2,9.9h37.7L1273.7,89.1"></path>
            ...
            <div class="footer-legal__right">
                ...
                <div class="footer-legal__seal" aria-hidden="true">
                    <img src="https://zavod-pt.kg/bitrix/templates/aspro_max/images/footer/performance.png"
                        alt="Печать" />
                </div>
            </div>
        </div> 
