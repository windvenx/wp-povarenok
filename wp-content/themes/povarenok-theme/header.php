...
<head>
    ...
    <?php wp_head(); ?>  <!-- Подключает стили, скрипты -->
</head>
<body <?php body_class(); ?>>
        ...
        <div class="container">
			...
			s-3.3-4-4.3-6.6h18.2c0.7,3,0.7,5.3-0.3,6.9C1168.7,90.4,1166.7,91.4,1163.7,91.4"></path>
                                        ...
                                        <path id="path62" class="st0"
                                            d="M1273.7,89.1h-12.9l-6.3-31.7H1243l6.3,31.7h-12.9l2,9.9h37.7L1273.7,89.1">
                                        </path>
			...
			s-1.3,0-1.7,0c-3,0-5.3-0.7-6.6-1.7c-1.7-1-2.6-2.3-3-4c-0.3-2,0-3.3,0.7-4.3C1581.3,66,1582.6,65.6,1584.2,65.6">
                    ...
                    <div class="branch-select">
                        <div class="branch-current" title="Текущий филиал">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" aria-hidden>
                                <path d="M12 2v20M5 9l7 7 7-7" stroke="#333" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <span>Бишкек</span>  <!-- Сделайте динамическим, если нужно (ACF поле) -->
                        </div>
                    </div>
                </div>
                <div class="header-center">
                    <form class="search-form" role="search" aria-label="Поиск по сайту" method="get" action="<?php echo home_url('/'); ?>">
                        <input class="search-input" type="search" name="s" placeholder="Поиск" aria-label="Поиск" value="<?php echo get_search_query(); ?>"/>
                        <button class="search-button" type="submit" aria-label="Поиск">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
                                <path d="M21 21l-4.35-4.35" stroke="#2a2a2a" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="header-right">
                    ...
                    <div class="action-icons">
                        <button class="icon-btn" title="Избранное">♡</button>  <!-- Интеграция с WooCommerce, если нужно -->
                        <button class="icon-btn" title="Корзина">🛒</button>
                        <button class="icon-btn" title="Профиль">👤</button>  <!-- Ссылка на аккаунт: <?php echo is_user_logged_in() ? 'Профиль' : 'Войти'; ?> -->
                    </div>
                </div>
            </div>
        </div>
